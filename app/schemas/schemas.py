...
class Person(BaseModel):
    ...
    age: Optional[int] = Field(None, gt=4, lt=99, example=20)
    ...
    # Вторым параметром идет проверяемое значение, его можно назв как угодно.
    # Декоратор @classmethod ставить нельзя, иначе валидатор не сработает.
    def name_cant_be_numeric(cls, value: str) -> str:
